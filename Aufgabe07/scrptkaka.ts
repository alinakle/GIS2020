namespace Aufgabe07 {
    ...
    let klassiker: HTMLElement = <HTMLElement>document.getElementById("Klassiker");
    let tiere: HTMLElement = <HTMLElement>document.getElementById("Tiere");
    let haushalt: HTMLElement = <HTMLElement>document.getElementById("Haushalt");
